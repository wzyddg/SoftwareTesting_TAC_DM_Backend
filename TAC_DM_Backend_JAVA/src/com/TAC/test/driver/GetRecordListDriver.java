...
public class GetRecordListDriver {
	static String fileNameString = "C:\\Users\\wzy\\Desktop\\1.0结果用例集\\UT_003_FUN_004.csv";
	...
	public static void main(String[] args) throws IOException {
		...
		while (reader.readRecord()) {
			...
			String result = "";
			try {
				result = DBQuerier.getRecordList(Integer.parseInt(record[3]));
			} catch (Exception e) {
