...
public class GetDeviceListDriver {
	static String fileNameString = "C:\\Users\\wzy\\Desktop\\1.0结果用例集\\UT_003_FUN_003.csv";
	...
	public static void main(String[] args) throws IOException {
		...
		while (reader.readRecord()) {
			...
			String result = "";
			try {
				result = DBQuerier.getDeviceList(record[3]);
				System.out.println(record[3]+" "+result);
			} catch (Exception e) {
